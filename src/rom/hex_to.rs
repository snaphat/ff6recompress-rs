...
mod test
{
    ...
    #[test]
    fn hex_to_range_error_overflow()
    {
    ...
    #[test]
    fn hex_to_range_error_invalid_hex()
    {
    ...
    #[test]
    fn hex_to_range_error_invalid_hex2()
    {
